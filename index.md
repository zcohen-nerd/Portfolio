...
- **[Sentry V3]({{ '/projects/sentry-v3/' | relative_url }})** — Embedded control platform for a pan-tilt actuation system, integrating sensors, motor drivers, and safety-oriented control logic.  
