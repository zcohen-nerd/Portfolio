...
- **Hardware & integration path:** [SURFER](/projects/surfer-fleet/) → [SENTRY](/projects/sentry-v3/) → [SPARK](/projects/stlink-v3mods/) — a deployed 20-vessel autonomous fleet, a deployed mechatronics platform, and a prototype bring-up tool.
- **Systems-tool / software path:** [Fusion System Blocks](/projects/fusion-system-blocks/) — system-architecture diagrams, typed connections, and rule checks inside CAD.

The complete taxonomy follows.
...
<div class="project-grid">
	<div class="project-card">
		...
		<p class="project-tag">Maritime autonomy</p>
	...
	<div class="project-card">
		...
		<p class="project-tag">Embedded control / mechatronics</p>
	...
	<div class="project-card">
		...
		<p class="project-tag">System-architecture tooling</p>
	...
	<div class="project-card">
		...
		<p class="project-tag">Hardware tooling</p>
...
<div class="project-grid">
	<div class="project-card concept-card">
		...
		<p class="project-tag">Embedded control / mechatronics · concept</p>
		<p>Planned ground-up redesign of the SENTRY platform with dedicated compute, control, and hardware-safety domains.</p>
		<p class="project-status"><strong>Concept</strong> — planning-stage, not a built or deployed system</p>
...
<div class="project-grid">
	<div class="project-card">
		...
		<p class="project-tag">Engineering documentation</p>
		...
		<p class="project-status"><strong>Published</strong> — v1.0 Source-Verified Release, continuously reviewed | <a href="https://github.com/zcohen-nerd/connector-engineering-field-guide">Source on GitHub</a></p>
	</div>
	<div class="project-card">
		...
		<p class="project-status"><strong>Public Beta</strong> | <a href="https://github.com/zcohen-nerd/PinmapGen">Source on GitHub</a></p>
	</div>
	<div class="project-card">
		...
		<p class="project-status"><strong>Public Beta</strong> | <a href="https://github.com/zcohen-nerd/FusionToGitHub">Source on GitHub</a></p>
	</div>
</div>
