...
{/* Route-scoped structured data. Only fields backed by this page's own visible
    content and the GitHub links it shows — no offers, ratings, or Organization. */}
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      description:
        'An Autodesk Fusion add-in that provides a system block-diagram editor inside the CAD environment — typed connections, CAD links, rule checks, snapshots, and 11 export formats.',
      applicationCategory: 'DeveloperApplication',
      operatingSystem: 'Autodesk Fusion',
      softwareVersion: '0.1.1',
      url: 'https://portfolio.zcohen-nerd.com/projects/fusion-system-blocks/',
      sameAs: 'https://github.com/zcohen-nerd/Fusion_System_Blocks',
      downloadUrl:
        'https://github.com/zcohen-nerd/Fusion_System_Blocks/releases',
      license:
        'https://github.com/zcohen-nerd/Fusion_System_Blocks/blob/main/LICENSE',
...
<ProjectAtAGlance
  ...
  role="Sole developer — Fusion add-in layer, HTML/JS panel, pure-Python core, and the export and rule engines"
  links={[
    {href: 'https://github.com/zcohen-nerd/Fusion_System_Blocks', label: 'Source on GitHub'},
    {href: 'https://github.com/zcohen-nerd/Fusion_System_Blocks/releases', label: 'Releases'},
  ]}>
...
- 11 export formats, including PDF report, BOM (bill of materials), connection matrix, and SVG
  ...
  items={[
    {
      ...
      reason:
        'The architecture → interfaces → implementation → integration method this tool is built to keep visible inside the CAD file.',
    },
    {
      href: 'https://github.com/zcohen-nerd/FusionToGitHub',
      title: 'FusionToGitHub',
      reason:
        'The same “keep the design and its history together” goal, solved with one-click version control instead of in-file diagrams.',
    },
    {
      href: '/documentation/selected-essays/',
      title: 'Selected Essays',
      reason:
        '“How Living Documentation Changes Engineering Culture” — the drift-between-model-and-plan problem System Blocks addresses.',
    },
  ]}
/>
