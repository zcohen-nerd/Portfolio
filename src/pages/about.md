...
- Designed and deployed 30+ custom PCBs for sensor integration, motion control, power distribution, and embedded processing across autonomous marine and robotics platforms — the [custom-PCB evidence appendix](/documentation/custom-pcb-portfolio/) lists the publicly documented boards and the institutional work behind the count.
...
- Course design and outcomes are detailed in the [Teaching Portfolio](/teaching/).
...
Peer-reviewed publications and conference presentations are collected on [Scholarship & Speaking](/documentation/scholarship/).
